        ...
        <div class="row text-center fh5co-heading row-padded">
            <div class="col-md-8 col-md-offset-2">
                <h2 class="heading to-animate"
                    style="--icon: url(<?= $arResult['ICON'] ?>);"><?= $arResult['TITLE'] ?></h2>
                    ...
                    if ($key == 'TOP_BIG'): ?>
                        ...
                        <div class="fh5co-v-half to-animate-2">
                            <div class="fh5co-v-col-2 fh5co-bg-img"
                                 style="background-image: url(<?= $DISHES['PREVIEW_PICTURE'] ?>)"></div>
                    ...
                    elseif ($key == 'TOP_SMALL'): ?>
                        ...
                        <div class="fh5co-v-half">
                            <div class="fh5co-h-row-2 to-animate-2">
                                <div class="fh5co-v-col-2 fh5co-bg-img"
                                     style="background-image: url(<?= $DISHES[0]['PREVIEW_PICTURE'] ?>)"></div>
                                <div class="fh5co-v-col-2 fh5co-text arrow-left">
                                    <h2><?= $DISHES[0]['NAME'] ?></h2>
                                    <span class="pricing">$<?= number_format(
                                            (float)$DISHES[0]['PRICE'],
                                            2,
                                            '.',
                                            ''
                                        ) ?></span>
                            ...
                            <div class="fh5co-h-row-2 fh5co-reversed to-animate-2">
                                <div class="fh5co-v-col-2 fh5co-bg-img"
                                     style="background-image: url(<?= $DISHES[1]['PREVIEW_PICTURE'] ?>)"></div>
                                <div class="fh5co-v-col-2 fh5co-text arrow-right">
                                    <h2><?= $DISHES[1]['NAME'] ?></h2>
                                    <span class="pricing">$<?= number_format(
                                            (float)$DISHES[1]['PRICE'],
                                            2,
                                            '.',
                                            ''
                                        ) ?></span>
